...
class COCODetection(DatasetSplit):
    ...
    _INSTANCE_TO_BASEDIR = {
        'objects365_train_20190423.json': 'train',
        'objects365_Tiny_train.json': 'train',
        'train': 'train',
        'objects365_val_20190423.json': 'val',
    ...
    for i in range(301, 366):
        COCO_id_to_category_id[i] = i - 300
    ...
    def __init__(self, basedir, split):
        ...
        annotation_file = os.path.join(
            basedir, 'annotations/{}'.format(split))
